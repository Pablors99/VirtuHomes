...
if (isset($_GET['admin'])) {
    ...
    $apartments = $apartmentController->showAvailable('', 0, $count_apartment, 'VENDIDO');
} else {
    $apartments = $apartmentController->showUserApartment($_SESSION['user']['id_usuario'], 'VENDIDO');
}
?>
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="h-100">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <p class="fs-6 fw-semibold text-success"><?= $apartment['estado'] ?></p>
                                </div>
...
<?php else: ?>
    <div class="col-md-6">
       <div class="card">
          <div class="card-body">
              <h2 class="card-title d-flex justify-content-center align-items-center">No tienes pisos que hayas vendido.</h2>
          </div>
       </div>
    </div>
<?php endif; ?>
