...
$apartments = $apartmentController->viewApartmentPurchased($_SESSION['user']['id_usuario']);
?>
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="h-100">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <p class="fs-6 fw-semibold text-info-emphasis text-end">
                                        COMPRADO
                                        <br>
                                        <span class="text-danger fw-light">Propietario antiguo: <?= $apartment['nombre_propietario'] ?> <?= $apartment['apellidos_propietario'] ?></span>
                                    </p>
                                </div>
...
<?php else: ?>
    <div class="col-md-6">
       <div class="card">
          <div class="card-body">
              <h2 class="card-title d-flex justify-content-center align-items-center">No has realizado la compra de ningún apartamento.</h2>
          </div>
       </div>
    </div>
<?php endif; ?>
